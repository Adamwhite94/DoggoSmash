...
import {DoggoContainer, DoggoElements, DoggoImageContainer, DoggoImage, DoggoButton, DoggoTitle, DoggoButtonContainer, SmallCounter} from './DoggoHomeStyles'
  ...
  return (
   <DoggoContainer>
    ...
    <DoggoElements>
        ...
        <DoggoButton onClick={(e)=>notCuteHandler(e)}>Not Cute</DoggoButton>
        </DoggoButtonContainer>
    </DoggoElements>: null}
    {endscreen ? 
    <DoggoElements>
